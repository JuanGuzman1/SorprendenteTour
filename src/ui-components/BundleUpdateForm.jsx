...
export default function BundleUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setP2pXilitla(cleanValues.p2pXilitla);
    setP3pXilitla(cleanValues.p3pXilitla);
    setP4pXilitla(cleanValues.p4pXilitla);
    setP5pXilitla(cleanValues.p5pXilitla);
    setP2pValles(cleanValues.p2pValles);
    setP3pValles(cleanValues.p3pValles);
    setP4pValles(cleanValues.p4pValles);
    setP5pValles(cleanValues.p5pValles);
    setErrors({});
  };
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          name: name ?? null,
          p2pXilitla: p2pXilitla ?? null,
          p3pXilitla: p3pXilitla ?? null,
          p4pXilitla: p4pXilitla ?? null,
          p5pXilitla: p5pXilitla ?? null,
          p2pValles: p2pValles ?? null,
          p3pValles: p3pValles ?? null,
          p4pValles: p4pValles ?? null,
          p5pValles: p5pValles ?? null,
        };
