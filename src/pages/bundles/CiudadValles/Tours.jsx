                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                      <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        {Math.floor(tour) <= 3 &&
                          `${Math.floor(
                            tour + 1
                          )} NOCHES EN HOTEL DE CIUDAD VALLES DE SU ELECCION`}
                        {tour === 4 &&
                          "3 NOCHES EN VALLES / 2 NOCHE EN XILITLA EN HOTEL DE SU ELECCION"}
                        {tour === 5 &&
                          "4 NOCHES EN VALLES / 2 NOCHES EN XILITLA EN HOTEL DE SU ELECCION"}
                        {tour === 6 &&
                          "5 NOCHES EN VALLES / 2 NOCHES EN XILITLA EN HOTEL DE SU ELECCION"}
                      </td>
