...
const Miradores = () => {
  return (
    <div className="mirador">
      <div
        className={`header-mirador bg-cover bg-center rounded-br-3xl flex justify-center items-center`}
      >
        <h1 className="text-white font-bold text-[50px]">Tour Miradores</h1>
      </div>
        ...
        <div className="flex md:flex-row flex-col m-7">
          <div className="self-center m-3">
            ...
            <p className="text-[20px] text-center">
              El tour más recomendado y preferido de muchos es este tour que te
              llevaremos a lugares impresionantes de la sierra de xilitla donde
              podrás observar flora y fauna maravillosa así como una experiencia
              única de manejar un off road, RZR, CAN-AM O CUATRIMOTO tu elije!
            </p>
          </div>
          <img
        ...
        >
          ...
          >
            <div class="p-5 border border-gray-200 dark:border-gray-700 dark:bg-gray-900 border-b-0">
              ...
              <p class="mb-2 text-gray-500 dark:text-gray-400">
                Hotel Tapasoli (nidos y madrigueras)
              </p>
              <p class="mb-2 text-gray-500 dark:text-gray-400">
                Xilitla Pueblo Mágico Centro
              </p>
              <p class="mb-2 text-gray-500 dark:text-gray-400">
          ...
          >
            <div class="p-5 border border-gray-200 dark:border-gray-700 border-t-0">
              <p class="mb-2 text-gray-500 dark:text-gray-400">2 a 3 horas</p>
            </div>
          </div>
        </div>
        {/* ruta */}
