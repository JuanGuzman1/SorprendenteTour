...
const Nanacatli = () => {
  ...
  return (
    <div className="nanacatli">
      <div className="w-3/4 relative">
        <div
          className={`header-nanacatli w-full bg-cover bg-center rounded-br-full flex justify-center items-center`}
        />
        <img
          ...
          src="../../../../../../assets/images/tours4x4/nanacatli/circle-1.jpg"
          alt="unknown"
        />
        <img
          ...
          src="../../../../../../assets/images/tours4x4/nanacatli/circle-2.jpg"
          alt="unknown"
        />
        <img
      ...
      <div className="flex m-5 flex-col">
        ...
        <div className="flex md:flex-row flex-col m-7">
          <div className="self-center m-3">
            ...
            <p className="text-[20px] text-[#f37810] font-bold">
              En este tour te llevaremos a la hermosa aldea de Nanacatli en RZR
              o Cuatrimoto donde podras dar un recorrido por el lugar, tomarte
              fotos fantasticas.
              <br />
              <br />
          ...
          <div className=" bg-[#f47a2d] md:w-[600px] md:h-[500px] w-[320px] h-[320px] rounded-full flex items-center flex-col justify-center">
        ...
        {/* <section className="m-5">
          ...
          <img
            src="assets/images/tours4x4/ruta-mirador.jpeg"
            alt=""
