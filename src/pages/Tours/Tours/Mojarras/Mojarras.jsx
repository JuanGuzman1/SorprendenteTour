          ...
          <div className="flex md:flex-row flex-col m-7">
            <div className="self-center m-3">
              ...
              <p className="text-[20px] text-center">
                ...
                común de la Huasteca Potosina, uno puede admirar las magníficas
                y diversas caídas de agua, además de un antiguo acueducto que ha
                sido devorado por la selva. En Puente de Dios usted podrá
                observar pozas de agua cristalina y azul, con diversas caídas de
                agua por los lados, además de una cueva oculta entre las
                pequeñas cascadas.
              </p>
              <p className="text-[20px] text-center">
            ...
            >
              <div class="p-5 border border-gray-200 dark:border-gray-700 dark:bg-gray-900 border-b-0">
                <p class="mb-2 text-gray-500 dark:text-gray-400">
                  ...
                  indiquen, visitamos los parajes de Puente de Dios lugar donde
                  tendremos actividades acuáticas: nadar en rio y entre
                  cascadas, pasar por cueva iluminada con los rayos del sol,
                  hacer algunos saltos opcional Cascadas de Tamasopo, en este
                  lugar realizaremos actividades acuáticas, como son nadar en el
                  rio, saltar de trampolines colgarse en la cuerda escuchar la
