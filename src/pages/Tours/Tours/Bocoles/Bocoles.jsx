        ...
        >
          ...
          >
            <div class="p-5 border border-gray-200 dark:border-gray-700 dark:bg-gray-900 border-b-0">
              <p class="mb-2 text-gray-500 dark:text-gray-400">
                ...
                visitamos parajes como el río Tambaque y las espectaculares
                Cascadas de Micos, en estos lugares realizaremos actividades
                acuáticas, como son nadar en el rio, apreciar aguas cristalinas,
                así como disfrutar de las muchas y grandes cascadas, realizar
                saltos de algunos puntos a pozas o ríos lo cual viene siendo
                opcional. También tenemos la actividad de Tirolesas y la famosa
                bicicleta aérea conocida en ingles como skybike, estos 2 últimos
                puntos tienen un costo adicional, pero lo valen por mucho.
                Terminamos explorando un corredor de Artesanías donde puedes
                comprar bellos recuerdos. Ven y deja atrás tus miedos.
              </p>
            </div>
          </div>
          ...
          >
            <div class="p-5 border border-gray-200 dark:border-gray-700 border-b-0">
              ...
              <p class="mb-2 text-gray-500 dark:text-gray-400">
                -Saltos de cascada son 7 de diferentes alturas que van de los 4
                a los 10 metros podremos saltar de cada una opcionalmente,
