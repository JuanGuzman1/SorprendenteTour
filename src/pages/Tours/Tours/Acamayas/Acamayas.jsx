          ...
          <div className="flex md:flex-row flex-col m-7">
            <div className="self-center m-3">
              ...
              <p className="text-[20px] text-center">
                Son un conjunto de parajes sumamente hermosos y paradisíacos en
                la Huasteca Potosina con cascadas y ríos de tonalidades azul
            ...
            >
              <div class="p-5 border border-gray-200 dark:border-gray-700 dark:bg-gray-900 border-b-0 w-full">
                <p class="mb-2 text-gray-500 dark:text-gray-400 w-full">
                  ...
                  del Meco, donde daremos un recorrido en canoa al pie de
                  cascada del meco, al igual que podremos hacer algunos saltos
                  de diferentes alturas, así como nadar en el rio también hay
                  actividades opcionales como lo es el. Tubing y salto de
                  cascadas (costo Adicional) , por ultimo vamos a la Cascada del
                  Salto, donde podremos nadar en sus formaciones de hermosas
                  albercas gigantes.
                </p>
              </div>
            </div>
